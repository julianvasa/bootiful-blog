...
public class Recipes implements Serializable {
    ...
    @Column(length = 5000, name = "instruction")
    ...
    @Column(length = 1000, name = "link")
    @ApiModelProperty(notes = "Recipe link to a page")
    private String link;

    @Column(length = 100, name = "time")
    ...
    @Column(length = 100, name = "category_id", insertable = false, updatable = false)
